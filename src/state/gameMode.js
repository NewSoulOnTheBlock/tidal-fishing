...
//            $SBF, aren't server-validated, and aren't added to the sellable
//            catch bag (catch & release).
//   Pro    — the full economy. Every cast spends one bait, catches are
//            server-validated and worth real $SBF you can sell.
//
...
/** True when the player is fishing for real $SBF value (bait required). */
