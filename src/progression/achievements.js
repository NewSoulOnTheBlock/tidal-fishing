...
export const ACHIEVEMENTS = [
  ...
  { id: 'earn_1k', label: 'First Grand', desc: 'Earn 1,000 $TIDAL', check: (stats) => stats.lifetimeEarnings >= 1000, icon: '💰', reward: 0 },
  { id: 'earn_10k', label: 'Big Earner', desc: 'Earn 10,000 $TIDAL', check: (stats) => stats.lifetimeEarnings >= 10000, icon: '💵', reward: 0 },
  { id: 'earn_100k', label: 'Six Figures', desc: 'Earn 100,000 $TIDAL', check: (stats) => stats.lifetimeEarnings >= 100000, icon: '💸', reward: 0 },
  { id: 'earn_1m', label: 'Millionaire', desc: 'Earn 1,000,000 $TIDAL', check: (stats) => stats.lifetimeEarnings >= 1000000, icon: '🤑', reward: 0 },
  ...
  { id: 'jackpot_winner', label: 'I Won The Lottery', desc: 'Catch an ultimate jackpot fish', check: (stats) => stats.jackpotCaught, icon: '🐂', reward: 0 },
